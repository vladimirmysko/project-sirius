...
export async function createSyllabus(formData: FormData) {
  ...
  - Ключ "month" ассоциирован с массивом, который, по всей видимости, содержит объекты для каждого месяца.
  - Есть ключ "weeks", который ассоциирован с массивом объектов. Каждый объект представляет собой одну неделю.
